...
$webMvcFolder = Join-Path $slnFolder "src/Plateaumed.EHR.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/Plateaumed.EHR.Web.Public"
...
dotnet restore Plateaumed.EHR.Web.sln
