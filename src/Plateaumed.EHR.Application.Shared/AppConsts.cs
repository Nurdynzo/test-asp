...
namespace Plateaumed.EHR
{
    ...
    public class AppConsts
    {
        ...
        /// </summary>
        public const string DefaultPassPhrase = "608cf993dfca4bed944e1a10d74371f2";
        ...
        public static string PrimaryRole = "primary_role";
        
        public static string FacilityId = "facility_id";
        
        public static string Name = "user_login_name";
        ...
        public const int MinEmailActivationExpirationHours = 1;
        public const int MaxEmailActivationExpirationHours = 72;
    }
}
