...
using Plateaumed.EHR.Auditing.Exporting;
using Plateaumed.EHR.Authorization;
using Plateaumed.EHR.Authorization.Users;
using Plateaumed.EHR.Dto;
using Plateaumed.EHR.EntityHistory;
using EntityHistoryHelper = Plateaumed.EHR.EntityHistory.EntityHistoryHelper;

namespace Plateaumed.EHR.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : EHRAppServiceBase, IAuditLogAppService
    {
