...
using Plateaumed.EHR.DemoUiComponents.Dto;

namespace Plateaumed.EHR.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : EHRAppServiceBase, IDemoUiComponentsAppService
    {
