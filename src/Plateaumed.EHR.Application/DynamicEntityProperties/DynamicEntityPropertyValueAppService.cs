...
using Plateaumed.EHR.DynamicEntityPropertyValues.Dto;
...
namespace Plateaumed.EHR.DynamicEntityProperties
{
    ...
    public class DynamicEntityPropertyValueAppService : EHRAppServiceBase, IDynamicEntityPropertyValueAppService
    {
