...
{
    public class EditionAppService : EHRAppServiceBase, IEditionAppService
    {
        ...
        {
            var editions = await _editionRepository.GetAll().Include(e => e.ExpiringEdition).ToListAsync();
            ...
            foreach (var edition in editions)
            {
                ...
                resultEdition.ExpiringEditionDisplayName = edition?.ExpiringEdition?.DisplayName;
        ...
        protected virtual async Task CreateEditionAsync(CreateEditionDto input)
        {
            ...
            edition.Name = input.Edition.DisplayName;
