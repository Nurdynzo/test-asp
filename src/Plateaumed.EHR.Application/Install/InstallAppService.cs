...
namespace Plateaumed.EHR.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : EHRAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<EHRDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{EHRConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{EHRConsts.ConnectionStringName}", constring);
        }
