...
using Plateaumed.EHR.MultiTenancy.Payments.Stripe;
...
{
    public class StripePaymentAppService : EHRAppServiceBase, IStripePaymentAppService
    {
        ...
        public async Task<string> CreatePaymentSession(StripeCreatePaymentSessionInput input)
        {
            ...
            { 
                ...
                {
                    new SessionLineItemOptions() { Price = plan.Id, Quantity = 1 }
                }; 
            }
            else
            {
                ...
                sessionCreateOptions.LineItems = new List<SessionLineItemOptions>()
                {
                    ...
                    { 
                        ...
                        {
                            UnitAmount = (long) _stripeGatewayManager.ConvertToStripePrice(payment.Amount),
