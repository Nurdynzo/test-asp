...
public class GetConsultationLetterQueryHandler : IGetConsultationLetterQueryHandler
{
    ...
    public GetConsultationLetterQueryHandler(IReferAndConsultBasedQuery basedQuery,
    ...
    public async Task<ConsultReturnDto> Handle(ConsultRequestDto request, User loginUser)
    {
        ...
        var referalLetter = new ConsultReturnDto()
        {
