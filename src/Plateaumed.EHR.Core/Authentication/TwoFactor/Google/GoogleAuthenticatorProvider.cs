...
namespace Plateaumed.EHR.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : EHRServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Plateaumed.EHR", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
