...
namespace Plateaumed.EHR.Authorization.Users
{
    ...
    public class UserManager : AbpUserManager<Role, User>, IUserManager
    {
        ...
        public virtual async Task<User> FindByIdExtendedAsync(UserIdentifier userIdentifier)
        {
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                using (_unitOfWorkManager.Current.SetTenantId(userIdentifier.TenantId))
                {
                    ...
                    .Include(u => u.PatientFk)
                    .Include(u => u.StaffMemberFk)
                    .Include(u => u.StaffMemberFk.Jobs)
                    .ThenInclude(u => u.JobServiceCentres)
                    .Include(u => u.StaffMemberFk.Jobs)
                    .ThenInclude(u => u.TeamRole)
                    .Include(u => u.StaffMemberFk.AssignedFacilities)
                    .Include("StaffMemberFk.AssignedFacilities.FacilityFk")
                    .FirstOrDefaultAsync(u => u.Id == userIdentifier.UserId);
                }
            });
        }
