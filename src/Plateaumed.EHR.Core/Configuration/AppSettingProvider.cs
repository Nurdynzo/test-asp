...
using Plateaumed.EHR.Authentication;
using Plateaumed.EHR.DashboardCustomization;
...
namespace Plateaumed.EHR.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        private IEnumerable<SettingDefinition> GetHostSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.UiManagement.Theme,
                 ...
                 new SettingDefinition(AppSettings.Email.EmailActivationExpirationHours,
                    GetFromAppSettings(AppSettings.Email.EmailActivationExpirationHours, "48"),
                    clientVisibilityProvider: _visibleSettingClientVisibilityProvider),

                  new SettingDefinition(AppSettings.Email.EnableEmailExpiration,
                    GetFromAppSettings(AppSettings.Email.EnableEmailExpiration, "true"),
                    clientVisibilityProvider: _visibleSettingClientVisibilityProvider),
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        EHRConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        EHRDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        EHRDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = EHRDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page
                    {
                        Name = EHRDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = EHRDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    EHRDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = EHRDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page
                    {
                        ...
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = EHRDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    EHRDashboardCustomizationConsts.Widgets.Tenant
        ...
        private SettingDefinition[] GetUploadProviderSettings()
        {
            return new[]
            {
                new SettingDefinition(
                    AppSettings.HostManagement.IsCloudUpload,
                    "true",
                    clientVisibilityProvider: _visibleSettingClientVisibilityProvider,
                    scopes: SettingScopes.Tenant,
                    isEncrypted: true
