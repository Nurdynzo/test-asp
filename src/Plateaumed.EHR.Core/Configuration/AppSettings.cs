namespace Plateaumed.EHR.Configuration
{
    ...
    public static class AppSettings
    {
        public static class HostManagement
        {
            ...
            public static string IsCloudUpload = "App.HostManagement.IsCloudUpload";
        }
        ...
        public static class Email
        {
            ...
            public const string EmailActivationExpirationHours = "App.Email.EmailActivationExpirationHours";
            public const string EnableEmailExpiration = "App.Email.EnableEmailExpiration";
        }
