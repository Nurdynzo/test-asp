...
using Plateaumed.EHR.Authorization.Ldap;
using Plateaumed.EHR.Authorization.Roles;
using Plateaumed.EHR.Authorization.Users;
using Plateaumed.EHR.Chat;
using Plateaumed.EHR.Configuration;
using Plateaumed.EHR.DashboardCustomization.Definitions;
using Plateaumed.EHR.Debugging;
using Plateaumed.EHR.DynamicEntityProperties;
...
using Plateaumed.EHR.WebHooks;
using Newtonsoft.Json;

namespace Plateaumed.EHR
{
    [DependsOn(
        typeof(EHRCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class EHRCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            EHRLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = EHRConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, EHRMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<EHRSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(EHRCoreModule).GetAssembly());
        }
