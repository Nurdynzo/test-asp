...
namespace Plateaumed.EHR.Features
{
    public class AppFeatureProvider : FeatureProvider
    {
        public override void SetFeatures(IFeatureDefinitionContext context)
        {
            ...
            var hospitalFeature = context.Create(
                AppFeatures.Hospital,
                defaultValue: "false",
                displayName: L("Hospital"),
                inputType: new CheckboxInputType()
            );
            
            hospitalFeature.CreateChildFeature(
                AppFeatures.LaboratoryEnabledHospitalFeature,
                defaultValue: "false",
                displayName: L("LaboratoryEnabledHospitalFeature"),
                inputType: new CheckboxInputType()
            );
            
            hospitalFeature.CreateChildFeature(
                AppFeatures.PharmarcyEnabledHospitalFeature,
                defaultValue: "false",
                displayName: L("PharmarcyEnabledHospitalFeature"),
                inputType: new CheckboxInputType()
            );
            
            var laboratoryFeature = context.Create(
                AppFeatures.Laboratory,
                defaultValue: "false",
                displayName: L("Laboratory"),
                inputType: new CheckboxInputType()
            );
            
            var pharmacyFeature = context.Create(
                AppFeatures.Pharmacy,
                defaultValue: "false",
                displayName: L("Pharmacy"),
                inputType: new CheckboxInputType()
            );
        }
