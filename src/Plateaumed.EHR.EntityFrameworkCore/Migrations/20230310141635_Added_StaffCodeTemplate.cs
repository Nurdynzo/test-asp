...
{
    /// <inheritdoc />
    public partial class AddedStaffCodeTemplate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "StaffCodeTemplates",
                columns: table =>
                    new
                    {
                        Id = table
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StaffCodeTemplates", x => x.Id);
                }
            );
        ...
        {
            migrationBuilder.DropTable(name: "StaffCodeTemplates");
        }
    }
}
