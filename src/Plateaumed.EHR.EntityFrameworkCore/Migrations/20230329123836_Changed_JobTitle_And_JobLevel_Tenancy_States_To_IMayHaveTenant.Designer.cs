...
namespace Plateaumed.EHR.Migrations
{
    ...
    [Migration("20230329123836_Changed_JobTitle_And_JobLevel_Tenancy_States_To_IMayHaveTenant")]
    partial class ChangedJobTitleAndJobLevelTenancyStatesToIMayHaveTenant
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "blood_pressure_position_type", new[] { "Left", "Right" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "facility_level", new[] { "Primary", "Secondary", "Tertairy" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "fundal_height_units_type", new[] { "Centimeters", "Inches" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "gender_type", new[] { "Male", "Female", "Other" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "heart_rate_measurement_site_type", new[] { "Axillary_Pulse", "Brachial_Pulse", "Carotid_Pulse", "Dorsal_Pedal_Pulse", "Femoral_Pulse", "Heart_Rate", "Popliteal_Pulse", "Post_Tibial_Pulse", "Radial_Pulse" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "heart_rate_position_type", new[] { "Left", "Right" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "height_measurement_site_type", new[] { "Standing", "Lying" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "height_units_type", new[] { "Centimeters", "Feet_Inches", "Meters" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "mid_upper_arm_circumference_position_type", new[] { "Left", "Right" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "mid_upper_arm_circumference_units_type", new[] { "Centimeters", "Inches" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "occipitofrontal_circumference_units_type", new[] { "Centimeters", "Inches" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "oxygen_source_type", new[] { "Room_Air", "Oxygen_Via_Nasal_Cannula", "Oxygen_Via_Face_Mask", "ETT_In_Situ" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "temperature_units_type", new[] { "Celcius", "Fahrenheit", "Kelvin" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "weight_units_type", new[] { "Kilogram", "Pounds" });
            ...
            modelBuilder.Entity("Plateaumed.EHR.Organizations.OrganizationUnitExtended", b =>
                {
                    ...
                    b.ToTable("AppOrganizationUnits");
            ...
            modelBuilder.Entity("Plateaumed.EHR.Authorization.Users.User", b =>
                {
                    ...
                    b.HasOne("Plateaumed.EHR.Staff.StaffMember", "StaffInfo")
                        .WithOne("UserInfo")
                        .HasForeignKey("Plateaumed.EHR.Authorization.Users.User", "StaffInfoId");
