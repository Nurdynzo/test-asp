...
namespace Plateaumed.EHR.Migrations
{
    ...
    [Migration("20230816164723_Added_PaymentType_Discount_Amount_To_Invoice")]
    partial class AddedPaymentTypeDiscountAmountToInvoice
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Plateaumed.EHR.Invoices.PricingRule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Plateaumed.EHR.Patients.Patient", b =>
                {
                    ...
                    b.Property<long?>("PatientOccupationCategoryFkId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("PatientOccupationCategoryFkId");
            ...
            modelBuilder.Entity("Plateaumed.EHR.Symptoms.Symptom", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Plateaumed.EHR.Facilities.Facility", b =>
                {
                    ...
                    b.HasOne("Plateaumed.EHR.Invoices.PricingRule", "PricingRule")
                        .WithMany()
            ...
            modelBuilder.Entity("Plateaumed.EHR.Patients.Patient", b =>
                {
                    ...
                    b.HasOne("Plateaumed.EHR.Patients.PatientOccupationCategory", "PatientOccupationCategoryFk")
                        .WithMany()
                        .HasForeignKey("PatientOccupationCategoryFkId");

                    b.HasOne("Plateaumed.EHR.Patients.PatientOccupation", null)
                        .WithOne("PatientFk")
                        .HasForeignKey("Plateaumed.EHR.Patients.Patient", "PatientOccupationCategoryId");

                    b.HasOne("Plateaumed.EHR.Patients.PatientOccupationCategory", null)
                        .WithOne("PatientFk")
                        .HasForeignKey("Plateaumed.EHR.Patients.Patient", "PatientOccupationCategoryId")
                        .HasConstraintName("FK_Patients_PatientOccupationCategories_PatientOccupationCate~1");
