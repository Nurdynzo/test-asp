...
namespace Plateaumed.EHR.Migrations
{
    ...
    [Migration("20230913164813_Add-Invoice-InvoiceItem-Money-Object")]
    partial class AddInvoiceInvoiceItemMoneyObject
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Plateaumed.EHR.Invoices.InvoiceItem", b =>
                {
                    ...
                    b.OwnsOne("Plateaumed.EHR.ValueObjects.Money", "TopUpAmount", b1 =>
                        {
                            b1.Property<long>("InvoiceItemId")
                                .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Plateaumed.EHR.Invoices.PricingSetting", b =>
                {
                    b.OwnsOne("Plateaumed.EHR.ValueObjects.Money", "GlobalDiscount", b1 =>
                        {
                            b1.Property<long>("PricingSettingId")
                                .HasColumnType("bigint");
                            ...
                            b1.HasKey("PricingSettingId");

                            b1.ToTable("PricingSettings");

                            b1.WithOwner()
                                .HasForeignKey("PricingSettingId");
                        });

                    b.Navigation("GlobalDiscount");
                });
