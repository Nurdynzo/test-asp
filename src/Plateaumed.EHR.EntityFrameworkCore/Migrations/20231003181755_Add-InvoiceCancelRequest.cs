...
{
    /// <inheritdoc />
    public partial class AddInvoiceCancelRequest : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<InvoiceCancelStatus>(type: "invoice_cancel_status", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoiceCancelRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InvoiceCancelRequests_Facilities_FacilityId",
                        column: x => x.FacilityId,
                        principalTable: "Facilities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InvoiceCancelRequests_InvoiceItems_InvoiceItemId",
                        column: x => x.InvoiceItemId,
                        principalTable: "InvoiceItems",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InvoiceCancelRequests_Invoices_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoices",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InvoiceCancelRequests_Patients_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceCancelRequests_FacilityId",
                table: "InvoiceCancelRequests",
                column: "FacilityId");

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceCancelRequests_InvoiceId",
                table: "InvoiceCancelRequests",
                column: "InvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceCancelRequests_InvoiceItemId",
                table: "InvoiceCancelRequests",
                column: "InvoiceItemId");

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceCancelRequests_PatientId",
                table: "InvoiceCancelRequests",
                column: "PatientId");
        }
