...
{
    /// <inheritdoc />
    public partial class AddPatientPhysicalExercises : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PatientPhysicalExercises",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    FrequencyPerWeek = table.Column<int>(type: "integer", nullable: false),
                    DurationPerMinute = table.Column<int>(type: "integer", nullable: false),
                    Intensity = table.Column<Intensity>(type: "intensity", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientPhysicalExercises", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PatientPhysicalExercises_Patients_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientPhysicalExercises_PatientId",
