...
{
    /// <inheritdoc />
    public partial class AddPatientPastMedicalCondition : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PatientPastMedicalConditions",
                columns: table => new
                {
                    ...
                    PeriodUnit = table.Column<UnitOfTime>(type: "unit_of_time", nullable: false),
                    Control = table.Column<ConditionControl>(type: "condition_control", nullable: false),
                    IsOnMedication = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    FrequencyUnity = table.Column<UnitOfTime>(type: "unit_of_time", nullable: false),
                    ...
                    NumberOfPreviousInfarctions = table.Column<int>(type: "integer", nullable: false),
                    IsHistoryOfAngina = table.Column<bool>(type: "boolean", nullable: false),
                    IsPreviousHistoryOfAngina = table.Column<bool>(type: "boolean", nullable: false),
                    IsPreviousOfAngiogram = table.Column<bool>(type: "boolean", nullable: false),
                    IsPreviousOfStenting = table.Column<bool>(type: "boolean", nullable: false),
                    IsPreviousOfMultipleInfarction = table.Column<bool>(type: "boolean", nullable: false),
                    IsStillIll = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientPastMedicalConditions", x => x.Id);
                });
        }
