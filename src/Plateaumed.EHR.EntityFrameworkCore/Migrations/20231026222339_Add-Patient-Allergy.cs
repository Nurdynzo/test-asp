        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllergySnomedId = table.Column<long>(type: "bigint", nullable: true),
                    Reaction = table.Column<string>(type: "text", nullable: true),
                    ReactionSnomedId = table.Column<long>(type: "bigint", nullable: true),
                    Notes = table.Column<string>(type: "text", nullable: true),
                    Severity = table.Column<Severity>(type: "severity", nullable: false),
