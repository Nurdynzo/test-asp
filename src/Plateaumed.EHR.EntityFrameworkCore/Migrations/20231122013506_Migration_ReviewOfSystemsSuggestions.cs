...
{
    /// <inheritdoc />
    public partial class MigrationReviewOfSystemsSuggestions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ReviewOfSystemsSuggestions",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewOfSystemsSuggestions", x => x.Id);
                });
        }
