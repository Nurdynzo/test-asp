...
{
    /// <inheritdoc />
    public partial class AddPriceConsultationSettings : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PriceConsultationSettings",
                columns: table => new
                {
                    ...
                    IsFollowUpVisitEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    FrequencyOfChargesTimes = table.Column<int>(type: "integer", nullable: false),
                    FrequencyOfChargeValue = table.Column<int>(type: "integer", nullable: false),
                    UnitOfFrequencyChargeUnit = table.Column<PriceTimeFrequency>(type: "price_time_frequency", nullable: false),
                    PercentageOfFrequencyCharges = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PriceConsultationSettings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PriceConsultationSettings_Facilities_FacilityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceConsultationSettings_FacilityId",
