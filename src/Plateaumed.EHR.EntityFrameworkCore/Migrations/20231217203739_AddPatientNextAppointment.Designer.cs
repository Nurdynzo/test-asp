...
namespace Plateaumed.EHR.Migrations
{
    ...
    [Migration("20231217203739_AddPatientNextAppointment")]
    partial class AddPatientNextAppointment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Plateaumed.EHR.AllInputs.PatientNextAppointment", b =>
                {
                    ...
                    b.HasOne("Abp.Organizations.OrganizationUnit", "OrganizationUnits")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
