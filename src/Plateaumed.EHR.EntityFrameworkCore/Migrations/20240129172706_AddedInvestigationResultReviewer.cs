...
{
    /// <inheritdoc />
    public partial class AddedInvestigationResultReviewer : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "InvestigationResultReviewer",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    InvestigationResultId = table.Column<long>(type: "bigint", nullable: false),
                    StaffMemberId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvestigationResultReviewer", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvestigationResultReviewer_InvestigationResultId",
                table: "InvestigationResultReviewer",
                column: "InvestigationResultId");

            migrationBuilder.CreateIndex(
                name: "IX_InvestigationResultReviewer_StaffMemberId",
                table: "InvestigationResultReviewer",
