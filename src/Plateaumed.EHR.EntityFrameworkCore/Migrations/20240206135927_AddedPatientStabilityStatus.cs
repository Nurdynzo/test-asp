...
{
    /// <inheritdoc />
    public partial class AddedPatientStabilityStatus : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<PatientStabilityStatus>(type: "patient_stability_status", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientStability", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PatientStability_PatientEncounters_EncounterId",
                        column: x => x.EncounterId,
                        principalTable: "PatientEncounters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PatientStability_Patients_PatientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientStability_EncounterId",
                table: "PatientStability",
                column: "EncounterId");

            migrationBuilder.CreateIndex(
                name: "IX_PatientStability_PatientId",
                table: "PatientStability",
                column: "PatientId");
        }
