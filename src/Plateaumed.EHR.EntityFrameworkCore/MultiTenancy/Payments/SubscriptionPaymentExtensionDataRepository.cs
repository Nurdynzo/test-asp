...
using Plateaumed.EHR.EntityFrameworkCore.Repositories;

namespace Plateaumed.EHR.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : EHRRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<EHRDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
