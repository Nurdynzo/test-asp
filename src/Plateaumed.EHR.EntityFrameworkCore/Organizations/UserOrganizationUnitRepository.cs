...
{
    public class UserOrganizationUnitRepository : EHRRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<EHRDbContext> dbContextProvider)
