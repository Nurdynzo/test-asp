...
using Plateaumed.EHR.Core.Base;
using Plateaumed.EHR.Dto;
using Plateaumed.EHR.Types;
using Plateaumed.EHR.Core.Extensions;
using GraphQL;
using UserType = Plateaumed.EHR.Types.UserType;

namespace Plateaumed.EHR.Queries
{
    public class UserQuery : EHRQueryBase<UserPagedResultGraphType, PagedResultDto<UserDto>>
    {
