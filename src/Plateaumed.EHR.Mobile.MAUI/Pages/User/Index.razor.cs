...
using Plateaumed.EHR.Mobile.MAUI.Models.User;
using Plateaumed.EHR.Core.Threading;
using Plateaumed.EHR.Mobile.MAUI.Services.User;
using Microsoft.AspNetCore.Components.Web.Virtualization;

namespace Plateaumed.EHR.Mobile.MAUI.Pages.User
{
    public partial class Index : EHRMainLayoutPageComponentBase
    {
