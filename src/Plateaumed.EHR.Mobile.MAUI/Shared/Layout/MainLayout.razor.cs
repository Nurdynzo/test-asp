...
using Plateaumed.EHR.Mobile.MAUI.Services.Account;
using Plateaumed.EHR.Mobile.MAUI.Services.UI;
using Microsoft.JSInterop;
using Plateaumed.EHR.Mobile.MAUI.Services.Tenants;

#if ANDROID
using Plateaumed.EHR.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace Plateaumed.EHR.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new Plateaumed.EHR.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
