...
using Plateaumed.EHR.Controls;
using Plateaumed.EHR.Dto;
using Plateaumed.EHR.Extensions;
using Plateaumed.EHR.Localization;
using Plateaumed.EHR.UI;
using Plateaumed.EHR.UI.Assets;
using Plateaumed.EHR.Views;
using DependencyResolver = Plateaumed.EHR.Core.Dependency.DependencyResolver;
...
namespace Plateaumed.EHR.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "EHR";
