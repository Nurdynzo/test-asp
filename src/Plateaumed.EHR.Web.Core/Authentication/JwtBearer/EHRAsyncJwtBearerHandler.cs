...
{
    public class EHRAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public EHRAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
