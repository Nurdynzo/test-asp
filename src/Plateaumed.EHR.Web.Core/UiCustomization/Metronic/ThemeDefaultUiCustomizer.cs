...
using Plateaumed.EHR.UiCustomization.Dto;

namespace Plateaumed.EHR.Web.UiCustomization.Metronic
{
        ...
        private void ValidateSettings(ThemeSettingsDto settings)
        {
            if (settings.Menu.AllowAsideMinimizing && !settings.Menu.HoverableAside)
            {
                throw new UserFriendlyException(
                    _localizationManager.GetSource(EHRConsts.LocalizationSourceName)
