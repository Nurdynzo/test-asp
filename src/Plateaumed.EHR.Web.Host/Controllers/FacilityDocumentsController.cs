...
{
    [Authorize]
    public class FacilityDocumentsController : EHRControllerBase
    {
        ...
        private readonly string[] DocumentAllowedFileTypes = { "jpeg", "jpg", "png", "pdf", "doc", "docx" };

        public FacilityDocumentsController(ITempFileCacheManager tempFileCacheManager)
        {
