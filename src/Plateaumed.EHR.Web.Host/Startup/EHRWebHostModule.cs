...
using Plateaumed.EHR.Authorization.Users.Password;
using Plateaumed.EHR.Configuration;
using Plateaumed.EHR.EntityFrameworkCore;
using Plateaumed.EHR.MultiTenancy;
using Plateaumed.EHR.Web.Startup.ExternalLoginInfoProviders;

namespace Plateaumed.EHR.Web.Startup
{
    [DependsOn(
        typeof(EHRWebCoreModule)
    )]
    public class EHRWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public EHRWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(EHRWebHostModule).GetAssembly());
        }
