...
namespace Plateaumed.EHR.Web.Public.Startup
{
    ...
    public class EHRWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public EHRWebFrontEndModule(IWebHostEnvironment env, EHREntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(EHRWebFrontEndModule).GetAssembly());
        }
    }
}
