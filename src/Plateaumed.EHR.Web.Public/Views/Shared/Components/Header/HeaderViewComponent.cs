...
using Plateaumed.EHR.Web.Public.Startup;
using Plateaumed.EHR.Web.Session;
using Plateaumed.EHR.Web.UiCustomization;

namespace Plateaumed.EHR.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : EHRViewComponent
    {
