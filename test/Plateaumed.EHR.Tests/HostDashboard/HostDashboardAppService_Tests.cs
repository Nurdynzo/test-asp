...
using Plateaumed.EHR.MultiTenancy.HostDashboard;
...
namespace Plateaumed.EHR.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        public async Task Should_Get_Daily_Income_Statistics_Data_For_Missing_Days()
        {
            ...
            UsingDbContext(
                context =>
                {
                    ...
                    context.Tenants.Add(new Tenant("MyTenant", "My Tenant", TenantType.Individual)
                    {
        ...
        private void CreatePaidPayment(EHRDbContext context, SubscriptionPayment subscriptionPayment)
        {
        ...
        public async Task Should_Get_Edition_Statistics()
        {
            ...
            UsingDbContext(
                context =>
                {
                    ...
                    context.Tenants.Add(new Tenant("SpecialEditionTenant", "Special Tenant", TenantType.Individual)
                    {
                        CreationTime = now.AddDays(-1),
                        SubscriptionEndDateUtc = utcNow.AddDays(1),
                    ...
                    context.Tenants.Add(new Tenant("PremiumEditionTenant", "Premium Tenant", TenantType.Individual)
                    {
                        SubscriptionEndDateUtc = utcNow.AddDays(1),
                        CreationTime = now.AddDays(-1),
