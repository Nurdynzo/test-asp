...
{
    [Trait("Category", "Unit")]
    public class LaboratoryQueueViewTestResultQueryHandlerTests
	{
        ...
        public async Task HandleGivenValidDetailsShouldReturnInvestigationTestInfo()
        {
            ...
            _investigationResult.GetAll().Returns(GetInvestigationResult().BuildMock());        

            var handler = new LaboratoryQueueViewTestResultQueryHandler(_patient, _investigationRequests, _investigationResult, _patientCodeMapping, _user);
            ...
            result.InvestigationResults.Count.ShouldBe(1);
        }
        ...
        private static IQueryable<InvestigationResult> GetInvestigationResult() =>
