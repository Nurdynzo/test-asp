...
[Trait("Category", "Unit")]
public class GetReferralLetterQueryHandlerTest
{
    ...
    [Fact]
    public async Task GetReferralLetterQueryHandler_Handle_Successful_Result()
    {
        //arrange 
        long patientId = 1;
        long staffUserId = 1;
        ...
        var handler = new GetReferralLetterQueryHandler(_basedQueryMock, _patientEncounterQueryHandlerMock,
        ...
        //Act
        var request = new ReferralRequestDto()
        {
            ReceivingHospital = "Sample Hospital",
