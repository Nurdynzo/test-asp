...
public class UpdateJobCommandHandlerTests
{
    ...
    private UpdateJobCommandHandler CreateHandler(IUserRepository userRepository)
    {
        return new UpdateJobCommandHandler(userRepository, _objectMapper,
            Substitute.For<IUserManager>(), Substitute.For<IRoleManager>(),
            Substitute.For<IRepository<Ward, long>>(), Substitute.For<IRepository<Job, long>>(),
            Substitute.For<ISetStaffRolesCommandHandler>());
    }
